...
!
!     type_SpherepackUtility.f, type_RealPeriodicFastFourierTransform.f, vhgsc.f, shsgs.f, compute_gaussian_latitudes_and_weights.f
!
...
contains
    ...
    module subroutine vrtgs(nlat, nlon, isym, nt, vort, ivrt, jvrt, cr, ci, mdc, ndc, &
        ...
        iwk = iis+nlat
        lwk = lwork-2*mn-nlat
        call vrtgs_lower_utility_routine(nlat, nlon, isym, nt, vort, ivrt, jvrt, cr, ci, mdc, ndc, &
            work(ia), work(ib), mab, work(iis), wshsgs, lshsgs, work(iwk), lwk, &
            ierror)

    end subroutine vrtgs

    subroutine vrtgs_lower_utility_routine(nlat, nlon, isym, nt, vort, ivrt, jvrt, cr, ci, mdc, ndc, &
        ...
        call shsgs(nlat, nlon, isym, nt, vort, ivrt, jvrt, a, b, mab, nlat, wsav, ierror)
