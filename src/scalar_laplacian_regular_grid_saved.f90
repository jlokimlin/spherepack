...
contains
    ...
    module subroutine slapes(nlat, nlon, isym, nt, slap, ids, jds, a, b, mdab, ndab, &
        ...
        iwk = ifn+nlat
        lwk = lwork-2*mn-nlat
        call slapes_lower_utility_routine(nlat, nlon, isym, nt, slap, ids, jds, a, b, mdab, ndab, &
            work(ia), work(ib), mmax, work(ifn), wshses, lshses, work(iwk), lwk, &
            ierror)

    end subroutine slapes

    subroutine slapes_lower_utility_routine(nlat, nlon, isym, nt, slap, ids, jds, a, b, mdab, ndab, &
