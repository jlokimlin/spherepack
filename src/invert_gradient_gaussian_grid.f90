...
contains
    ...
    subroutine igradgc(nlat, nlon, isym, nt, sf, isf, jsf, br, bi, mdb, ndb, &
        ...
        ! Local variables
        integer(ip) :: imid, n1, n2, ls
        integer(ip) :: lwork, mab, mmax, mn
        ...
        associate (lshsgc => size(wshsgc))
            ...
            block
                ...
                call igradgc_lower_utility_routine(nlat, nlon, isym, nt, sf, isf, jsf, &
                    work(ia:), work(ib:), mab,  work(iis:), mdb, ndb, br, bi, wshsgc, &
                    lshsgc, work(iwk:), liwk, ierror)
            end block
        end associate
