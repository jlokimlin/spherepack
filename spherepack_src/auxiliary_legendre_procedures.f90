...
!
!
!     file auxiliary_legendre_procedures.f90 contains subroutines
!
...
contains
    ...
    subroutine lfin1(init, theta, l, m, nm, id, p3, phz, ph1, p1, p2, cp)
        ...
        integer (ip), intent (in)  :: nm
        integer (ip), intent (in)  :: id
        real (wp),    intent (out) :: p3(id, 1)
        real (wp),    intent (out) :: phz(l,1)
        real (wp),    intent (out) :: ph1(l,1)
        real (wp),    intent (out) :: p1(l,1)
        real (wp),    intent (out) :: p2(l,1)
